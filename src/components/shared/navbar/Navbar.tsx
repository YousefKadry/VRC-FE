...
const Navbar = () => {
    ...
    return (
        <header className="flex justify-between items-center bg-primary py-3.5 px-10 md:px-20 shadow-lg relative z-50">
            <Link to="/home">
            ...
            <div className="flex items-center md:gap-4">
                <div className="flex items-center">
                    ...
                    <button
                        className="ml-4 bg-homeBg rounded-md px-3 py-1.5 items-center font-bold hidden md:flex"
                        onClick={isAuth ? handleSignOutClick : handleSignInClick}
                    >
                        {isAuth ? (
                            <>
