                ...
                <ul className=" flex flex-col">
                    <button
                        ...
                        className={`p-[2.25rem] w-full ${
                            focused === 'button1' && isCollapsed === false ? 'bg-[#311B52]' : ''
                        }`}
                    >
                    ...
                    <button
                        ...
                        className={`p-[2.25rem] w-full ${
                            focused === 'button2' && isCollapsed === false ? 'bg-[#311B52]' : ''
                        }`}
                    >
                    ...
                    <button
                        ...
                        className={`p-[2.25rem] w-full ${
                            focused === 'button3' && isCollapsed === false ? 'bg-[#311B52]' : ''
                        }`}
                    >
                    ...
                    <button
                        ...
                        className={`p-[2.25rem] w-full ${
                            focused === 'special-effect' && isCollapsed === false ? 'bg-[#311B52]' : ''
                        }`}
                    >
                        <FontAwesomeIcon className="text-white text-4xl" icon={faStarHalfStroke} />
                    </button>

                    <button
                        onClick={() => handleFocus('button4')}
                        className={`p-[2.25rem] w-full ${
                            focused === 'button4' && isCollapsed === false ? 'bg-[#311B52]' : ''
                        }`}
                    >
                    ...
                    <button
                        ...
                        className={`p-[2.25rem] w-full ${
                            focused === 'button5' && isCollapsed === false ? 'bg-[#311B52]' : ''
                        }`}
                    >
