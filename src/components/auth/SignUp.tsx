        ...
        <div className="w-full px-5">
          ...
          <form className="mt-6 w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-between my-6">
              <CustomInput
                className="pl-8 w-full sm:w-1/2 sm:mr-2 mb-6 sm:mb-0"
                placeholder="First Name"
                onInputChange={handleFNameInputChange}
              />
              <CustomInput
                className="pl-8 w-full sm:w-1/2 sm:ml-2"
                placeholder="Last Name"
                onInputChange={handleLNameInputChange}
              />
            </div>
            {/* Email Input */}
